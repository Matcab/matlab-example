...
'-- TEMPLATE MATLAB
'-- ============================================================================
'--  Filename : launch_template-matlab-v2.0_dev.vbs (for CAELA lauching)
'-- ============================================================================
'-- This file is used to:
'--   * launch appli from CAELA (XML)
'--    
'-- ============================================================================
'-- Revision History:
'-- ----------------
'-- AUTHOR                  	DATE        	COMMENT
'-- 
'-- M.CABANES                   04-Jun-2009     Creation
'-- O.DUFOUR                    05-May-2010     Update to version 1.1
'-- M.CAZENAVE                  20-Jun-2010     Update to version 2.0
'-- M.CABANES                   19-Jun-2014     Update to version 3.0
'-- <Name> <Company>        	yyyy/mm/dd 	<Description of the modification>
'--                                    		<Description of the modif. (continuation)>
'-- 
'-- ============================================================================
'-- ============================================================================
'-- Declaration section
...
'-- ============================================================================
'-- set/read variables if needed TO UPDATE
'-- ============================================================================
my_appli_name = "matlab-template"
my_appli_release = "3.0"  '-- to be updated according to the current release
...
'-- 
'-- remove the following line if you do not need traces
'-- wss.run current_dir &"\caplog.exe " &" -dCAE -aTEMPLATE -eMATLAB -v" &my_appli_release &" -mTOOL -cRUN -lFROM_CAELA"
'--
wss.run current_dir &"\launch_" &my_appli_name &"_dev.bat " &my_appli_home &" " &my_appli_release
WScript.quit(0)
