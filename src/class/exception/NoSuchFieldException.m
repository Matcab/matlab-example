function obj_OUT = NoSuchFieldException(varargin)
%==========================================================================
%% VOLVO GTT 2013
%==========================================================================
% MATLAB CLASS
%==========================================================================
% FILENAME: NoSuchFieldException.m
% PATH    : class\exception
%==========================================================================
% ABSTRACT: Create a "NoSuchField" exception 
%==========================================================================
% REVISION HISTORY:
...
% --------------
% Default message
message='The class doesn''t have a field of a specified name';
...
% ------------------------------
obj_OUT=MException('MATLAB:NoSuchFieldException', '%s', message);
